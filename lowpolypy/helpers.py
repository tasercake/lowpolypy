...
OPTIONS = {
    'longest_edge': [600],
    'canny_low_threshold': [150, 0],
    'canny_high_threshold': [200, 50],
    'random_replace_ratio': [0.],
    'num_random_points': [100],
    'num_canny_points': [1000, 500, 2500],
    'num_laplace_points': [0],
    'jiggle_min_ratio': [0.],
    'jiggle_max_ratio': [0.003],
    'post_saturation': [0.25],
    'post_brightness': [-0.08],
    'post_contrast': [0.2],
